...
<div className="container-fluid nv_bg">
      <div className="row">
            <div className="col-10 mx-auto">
                ...
                <div className="col-md-6 pt-5 pt-lg-0order-2 order-lg-1 d-flex justify-content-center flex-column">  
                    <h1> {props.name} <strong className="brand-name">  AAA Technical </strong></h1>
